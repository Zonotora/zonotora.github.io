...
As in every training plan, the goal is to shift the lactate curve to the right (see #fig-lactate). This will of course allow higher speeds at lower lactate levels as we would accumulate lactate slower. As with the \_Norwegian method\*, the core training efforts will occur below the second lactate threshold (LT2).
