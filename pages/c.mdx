...
A way to reduce the amount of repetitive code while making sure that names correspond to each other in different places we can make use of the following macro taken from the [llvm-project](https://github.com/llvm/llvm-project):
