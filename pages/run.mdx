...
<div className="table">
  <label id="tab-norwegian-singles">
    An example of a weekly workout plan for _Norwegian singles_.
  </label>
...
<div className="figure">
  <label id="fig-lactate">
    Curve highlighting the lactate threshold levels LT1 and LT2.
  </label>
